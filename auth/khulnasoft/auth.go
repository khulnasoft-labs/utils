// khulnasoft contains khulnasoft cloud platform related features
...
var (
	DashBoardURL     = "https://cloud.khulnasoft.com"
	DefaultApiServer = "https://api.khulnasoft.com"
)
...
func CheckNValidateCredentials(toolName string) {
	...
	fmt.Printf("[*] Enter KHULNASOFT API Key (exit to abort): ")
...
func userIdentifier(creds *KHULNASOFTCredentials) string {
